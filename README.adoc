...
`⛱` - Indicates a member has retired from the program.
...
|{counter:idx}
|image:images/avatars/rodrigograciano.png[]
|Rodrigo Graciano
|link:https://twitter.com/rodrigograciano[@rodrigograciano]
|New York City, New York
|USA/Brazil
|2022
...
|{counter:idx}
|image:images/avatars/DanHeidinga.png[]
|Dan Heidinga
|link:https://twitter.com/DanHeidinga[@DanHeidinga]
|Ottawa, Ontario
|Canada
|2022
...
|{counter:idx}
|image:images/avatars/mthmulders.png[]
|Maarten Mulders
|link:https://twitter.com/mthmulders[@mthmulders]
|Apeldoorn
|The Netherlands
|2022
...
|Erin Schnabel
|link:https://twitter.com/ebullientworks[@ebullientworks] link:https://fosstodon.org/@ebullient[@ebullient@fosstodon.org]
