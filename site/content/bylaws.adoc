...
Once a nomination has been submitted and processed by Oracle's Java Champions Team, or seven days after the submission
if Oracle has not responded, the nomination will be announced on the Group Mailing List. This initiates a two-week discussion period during which Group members can discuss the candidate without voting.
